...
export default function TypingInput({ gameState, onGameStart, difficulty, difficultyChangeHandler, text }) {
        ...
        <div className="absolute">
            ...
            {gameState === GAME_STATES.NOT_STARTED && (
                <div id="buttonOverlay" className="absolute top-0 left-0 w-full h-full flex flex-col gap-4 justify-center items-center">
                    <button id="startBtn" className="py-2 px-5 bg-fem-blue-600 rounded-lg text-fem-neutral-0" onClick={startGame}>
